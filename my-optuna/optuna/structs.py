...
class FrozenTrial(
    NamedTuple(
        ...
        [('trial_id', int),
         ...
         ('params_in_internal_repr', Dict[str, Union[float, Dict]]),
         ('timedelta_sampling_elapsed', Optional[timedelta])
         ])):
    ...
    Attributes:
        ...
        timedelta_sampling_elapsed:
            Datetime's timedelta for sampling.
    """
