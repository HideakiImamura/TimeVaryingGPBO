...
class InMemoryStorage(base.BaseStorage):
    ...
    def set_sampling_timedelta(self, trial_id, timedelta_sampling_elapsed):
        ...
        with self._lock:
            if self.trials[trial_id].timedelta_sampling_elapsed is None:
                self.trials[trial_id] = \
                    self.trials[trial_id]._replace(timedelta_sampling_elapsed=timedelta_sampling_elapsed)
            else:
                self.trials[trial_id].timedelta_sampling_elapsed += timedelta_sampling_elapsed
